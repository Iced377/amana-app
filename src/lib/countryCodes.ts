...
export const countryCodes = [
  ...
  { code: "+1-809", name: "Dominican Republic", flag: "🇩🇴" }, // and +1-829, +1-849
  ...
  { code: "+599", name: "Netherlands Antilles", flag: "🇧🇶" }, // Bonaire, Sint Eustatius and Saba
  ...
  { code: "+1-787", name: "Puerto Rico", flag: "🇵🇷" }, // and +1-939
  ...
  { code: "+500", name: "South Georgia and the South Sandwich Islands", flag: "🇬🇸" },
