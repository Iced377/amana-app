  ...
  return (
    <div className="space-y-8">
      ...
      <Card className="shadow-md bg-amber-50 dark:bg-amber-900/30 border-amber-500">
        <CardHeader>
          <CardTitle className="flex items-center gap-2 text-amber-700 dark:text-amber-300"><Info className="h-6 w-6" /> Important Disclaimer</CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-amber-700 dark:text-amber-400">
            Guardian Angel provides informational tools and guidance. We are not qualified to offer legal or religious advice.
            <strong>Always consult with a qualified Islamic scholar and a legal professional</strong> specializing in Islamic estate planning to ensure your arrangements are compliant and legally sound in your jurisdiction.
          </p>
        </CardContent>
      </Card>
      ...
      <Card className="shadow-md">
        <CardHeader>
            <CardTitle className="flex items-center gap-2"><Users className="h-6 w-6 text-primary"/> Identifying Your Islamic Heirs</CardTitle>
      ...
      <Card className="shadow-md">
        <CardHeader>
          <CardTitle className="flex items-center gap-2"><BookOpen className="h-6 w-6 text-primary" /> Learn More</CardTitle>
        ...
        <CardContent className="space-y-3">
          ...
          <p className="text-sm text-muted-foreground">Consider these external resources (Guardian Angel is not responsible for external content):</p>
