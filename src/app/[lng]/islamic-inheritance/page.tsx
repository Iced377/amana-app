  ...
  return (
    <div className="space-y-8">
      ...
      <Card className="shadow-md bg-amber-50 dark:bg-amber-900/30 border-amber-500">
        <CardHeader>
          <CardTitle className="flex items-center gap-2 text-amber-700 dark:text-amber-300"><Info className="h-6 w-6" /> Important DisclaimerCardTitle>
        CardHeader>
        <CardContent>
          p className="text-amber-700 dark:text-amber-400">
            Amana provides informational tools and guidance. We are not qualified to offer legal or religious advice.
            <strong>Always consult with a qualified Islamic scholar and a legal professionalstrong> specializing in Islamic estate planning to ensure your arrangements are compliant and legally sound in your jurisdiction.
          p>
        CardContent>
      Card>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <Card className="shadow-md">
          <CardHeader>
            ...
            <CardDescription>Designate up to one-third of your estate for non-heirs or charitable causes.CardDescription>
          CardHeader>
          <CardContent className="space-y-4">
            ...
            p>
            <Image src="https://picsum.photos/seed/wasiyyah/400/200" alt="Islamic calligraphy for Wasiyyah" width={400} height={200} className="rounded-md object-cover" data-ai-hint="Islamic calligraphy scroll"/>
        ...
        <Card className="shadow-md">
          <CardHeader>
            ...
            <CardDescription>Understand the fixed shares for designated heirs as per Islamic law.CardDescription>
          CardHeader>
          <CardContent className="space-y-4">
            <p className="text-sm text-muted-foreground">
            ...
            p>
             <Image src="https://picsum.photos/seed/faraid/400/200" alt="Diagram representing Faraid distribution" width={400} height={200} className="rounded-md object-cover" data-ai-hint="family tree diagram"/>
      ...
      <Card className="shadow-md">
        <CardHeader>
            <CardTitle className="flex items-center gap-2"><Users className="h-6 w-6 text-primary"/> Identifying Your Islamic HeirsCardTitle>
            <CardDescription>List potential heirs according to Islamic guidelines.CardDescription>
        CardHeader>
        <CardContent>
      ...
      <Card className="shadow-md">
        <CardHeader>
          <CardTitle className="flex items-center gap-2"><BookOpen className="h-6 w-6 text-primary" /> Learn MoreCardTitle>
          <CardDescription>Resources for understanding Islamic inheritance.CardDescription>
        CardHeader>
        <CardContent className="space-y-3">
          <p className="text-sm text-muted-foreground">
            It's highly recommended to educate yourself on these important matters.
          p>
          <Button variant="link" asChild><Link href={`/${currentLocale}/info-help#islamic-inheritance`}>Read Our Guide on Islamic InheritanceLink>Button>
          <p className="text-xs text-muted-foreground">
            (This will link to relevant sections in the Info &amp; Help page.)
          p>
          p className="text-sm text-muted-foreground">Consider these external resources (Amana is not responsible for external content):p>
          <ul className="list-disc list-inside text-sm space-y-1 pl-4">
            <li><Link href="#" className="text-primary hover:underline">Resource on Wasiyyah (Example Link)Link>li>
            <li><Link href="#" className="text-primary hover:underline">Resource on Faraid (Example Link)Link>li>
          ul>
        CardContent>
      Card>
    div>
